<?php
    ...
    $sql_4 = mysqli_query($conn, "SELECT COUNT(*) as contact_us_count FROM contact_us");
    $row4 = mysqli_fetch_assoc($sql_4);
?>
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php echo $row4['contact_us_count']; ?></h3>
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">All User Details</h3>
                    <div class="col">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!--blocking action  Start -->
                                        <td>
                                            
                                        <div class="d-grid gap-2 d-md-block">
                                        <a class="btn btn-danger" href="status.php?id=<?php echo $row['user_id']?>">Block</a>
                                        
                                        <a  class="btn btn-info" href="status.php?id2=<?php echo $row['user_id']?>">Unblock</a>
                                        
                                        </div>
                                        
                                        </td>
                                        <!--blocking unblocking action ends -->
                                    </tr>
                                <?php
                                    }
                                ?>
