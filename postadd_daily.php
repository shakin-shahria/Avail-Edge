    ...
    if(isset($_POST['submit'])){
        ...
        if(count($error)==0){
            ...
            if($id != $check_id){
                ...
                ('$id','$job','$places','$payment','$time','$des','Daily')";
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <h1 class="p-3  mx-5 text-center">Daily Job</h1>
                    <div class="mb-3 mx-5">
                        <label>Id</label>
                    ...
                    <div class="mb-3 mx-5">
                        ...
                        <?php if(isset($job) && $job == 'electrician') {echo 'checked';} ?>>electrician<br>
                        <input type="radio" name = "job" value= "Technician"
                        <?php if(isset($job) && $job == 'Technician') {echo 'checked';} ?>>Technician <br>
                        <input type="radio" name = "job" value= "Plumber"
                        <?php if(isset($job) && $job == 'Plumber') {echo 'checked';} ?>>Plumber <br>
