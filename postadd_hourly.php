    ...
    if(isset($_POST['submit'])){
        ...
        if(count($error)==0){
            ...
            if($id != $check_id){
                ...
                ('$id','$job','$places','$payment','$time','$des','Hourly')";
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <h1 class="p-3  mx-5 text-center">Hourly Job</h1>
                    <div class="mb-3 mx-5">
                        <label>Id</label>
                    ...
                    <div class="mb-3 mx-5">
                        ...
                        <br>
                        <input type="radio" name = "job" value= "Photographer"
                        <?php if(isset($job) && $job == 'Photographer') {echo 'checked';} ?>>Photographer<br>
                        <input type="radio" name = "job" value= "DJ"
                        <?php if(isset($job) && $job == 'DJ') {echo 'checked';} ?>>DJ <br>
                        <input type="radio" name = "job" value= "Writer"
                        <?php if(isset($job) && $job == 'Writer') {echo 'checked';} ?>>Writer <br>
